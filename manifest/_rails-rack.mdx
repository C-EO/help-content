...
|`locked_passenger_version` (*deprecated*)|<Glyph icon="upgrade" />|Force the app to use a specific version of Passenger. This is not supported on Passenger Enterprise applications.|All|
