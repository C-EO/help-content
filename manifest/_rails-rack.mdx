...
|`locked_passenger_version` (*deprecated*)|<Glyph icon="upgrade" />|This field is deprecated because the version of Passenger is fixed with the version of NGINX that Cloud 66 compiles. Use Application Updates for the latest available NGINX/Passenger version.|All|
