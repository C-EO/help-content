...
description: Every tool exposed by the Cloud 66 MCP server, with its arguments, required scope and behaviour.
lead: The complete list of the 33 tools an AI agent can call on the Cloud 66 MCP server.
---
...
<Callout type="info" title="Cloud 66 Deploy v3">
