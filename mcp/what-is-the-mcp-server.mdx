---
title: The Cloud 66 MCP server
description: Connect AI agents like Claude to your Cloud 66 account using the Model Context Protocol (MCP), and let them list, inspect, deploy and manage your applications.
lead: The Cloud 66 MCP server lets AI agents work with your Cloud 66 account directly — listing applications, checking deployments, deploying code and provisioning infrastructure — under permissions you choose and can revoke at any time.
---
...
[Connecting your AI agent](/:product/:version?/mcp/connecting-your-ai-agent).
</Callout>
...
[Tool reference](/:product/:version?/mcp/tools-reference).

<Callout type="info" title="Cluster tools are Cloud 66 Deploy v3">
...
[Cloud 66 Deploy v3](/:product/:version?/getting-started/deploy-v2-vs-v3) native Kubernetes
...
2. **Scopes.** On that consent screen you choose exactly which permissions the agent gets — for
   ...
   [Permissions and scopes](/:product/:version?/mcp/permissions-and-scopes).
...
they're called. See [Approving sensitive actions](/:product/:version?/mcp/approving-sensitive-actions).
...
Every MCP action is written to your account's [audit log](/:product/:version?/account/audit-logs)
...
- [Connect your AI agent](/:product/:version?/mcp/connecting-your-ai-agent)
- [Choose permissions and scopes](/:product/:version?/mcp/permissions-and-scopes)
- [Understand the approval flow](/:product/:version?/mcp/approving-sensitive-actions)
- [Browse the tool reference](/:product/:version?/mcp/tools-reference)
