---
title: Approving sensitive MCP actions
description: How Cloud 66 asks you to confirm destructive AI agent actions in your browser, including the cloud credential handoff.
lead: Some MCP tools can't run on the agent's say-so alone. Cloud 66 pauses the call and asks you to confirm it in your browser, with two-factor authentication.
---
...
<Callout type="warning" title="Read the page, not the prompt">
...
<Callout type="info" title="Never paste credentials into a chat">
...
[Enabling two-factor authentication](/:product/:version?/account/two-factor-authentication).
...
your [audit log](/:product/:version?/account/audit-logs).
...
[authorize it](/:product/:version?/mcp/permissions-and-scopes).
