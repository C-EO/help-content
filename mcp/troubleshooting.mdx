---
title: Troubleshooting the MCP server
description: Common Cloud 66 MCP errors — connection failures, missing tools, permission errors and approval problems — and how to fix them.
lead: What the errors mean, and what to do about them.
---
...
The [tool reference](/:product/:version?/mcp/tools-reference) lists the scope each tool needs.
...
[availability rules](/:product/:version?/mcp/tools-reference) and cloud sizes or regions that
...
[two-factor authentication](/:product/:version?/account/two-factor-authentication) on your account,
then retry.
...
Check your [audit log](/:product/:version?/account/audit-logs) — MCP activity is recorded there with
